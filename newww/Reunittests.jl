...
#         end
#         @connect begin
#             step1.out => b1.v_ENG2ENG_MNT_F_mps
...
#         end
#         @connect begin
#             step1.out => b1.v_ENG2ENG_MNT_R_mps
...
#         end
#         @connect begin
#             step1.out => b1.F_ENG_MNT_F2ENG_N
...
#             step1= Step(steptime=0.1, finalvalue=5)
#             step2= Step(steptime=0.1, finalvalue=10)
#             step3= Step(steptime=0.1, finalvalue=15)
#         end
#         @connect begin
#             step1.out => b.F_HM_HD_F_N
#             step2.out => b.F_HM_VS_F_N
...
#         end
#         @connect begin
#             step1.out => b.F_HM_HD_R_N
#             step2.out => b.F_HM_VS_R_N
...
#         end
#         @connect begin
#             step1.out => p.v_HM_BD_F2ST_F_mps
...
#         end
#         @connect begin
#             step1.out => p.v_HM_BD_R2ST_R_mps
...
@testset "SUS_F_PNT2" begin
    @model testblock begin
        @block begin
            m = SUS_F_PNT2()
            step1 = Constant(value=10) #Step(steptime=0.1, finalvalue=5)
            step2 = Constant(value=20) #Step(steptime=0.1, finalvalue=10)
        end
        @connect begin
            step1.out => m.v_VL2SUS_F_mps2
            step2.out => m.v_MUS_F2SUS_F_mps2
        end
        @scope begin
            m.v_VL2SUS_F_mps2 => v_VL2SUS_F_mps2
            m.v_MUS_F2SUS_F_mps2 => v_MUS_F2SUS_F_mps2
            m.F_SUS_F2VL_N2 => F_SUS_F2VL_N2
            m.F_SUS_F2MUS_F_N2 => F_SUS_F2MUS_F_N2
        end
    end
...
#             step2 = Step(steptime=0.1, finalvalue=10)
#             step3 = Step(steptime=0.1, finalvalue=15)
#             step4 = Step(steptime=0.1, finalvalue=20)
#             step5 = Step(steptime=0.1, finalvalue=25)
#             step6 = Step(steptime=0.1, finalvalue=30)
#         end
#         @connect begin
#             step1.out => p.F_ENG_MNT_F2VL_N
#             step2.out => p.F_ENG_MNT_R2VL_N
#             step3.out => p.F_ST_F2VL_N
#             step4.out => p.F_ST_R2VL_N
#             step5.out => p.F_SUS_R2VL_N
...
#         end
#         @connect begin
#             step1.out => m.F_ENG_MNT_F2VL_N
#             step2.out => m.F_ENG_MNT_R2VL_N
#             step3.out => m.F_ST_F2VL_N
#             step4.out => m.F_ST_R2VL_N
#             step5.out => m.F_SUS_R2VL_N
